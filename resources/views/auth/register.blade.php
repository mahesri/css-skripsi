          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" action="{{ route('auth.store')  }}" method="POST">
                  ...
                  <div>
                      ...
                      <input type="text" name="name" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Your name" required="" autofocus>
                  </div>
                  <div>
              ...
              px-4 py-3 mt-6">Create an account</button>
                  <p class="text-sm font-light text-gray-500">
                      Already have an account? <a href="{{ url('/auth') }}" class="text-blue-500 hover:text-blue-700 font-semibold">Login here</a>
                  </p>
              </form>
          </div>
      </div>
