        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto min-h-screen lg:py-0">
            <div class="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
                <div class="p-6 space-y-4 md:space-y-6  sm:p-8">
                    ...
                    <h1 class="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl mb-4">Recommendation results</h1>
...
{{--                                 Previous--}}
                                ...
                                @else
                                    <a href="{{ $finalResultsPaginated->previousPageUrl() }}"
                                       class="px-3 py-2 text-sm text-gray-700 bg-white border rounded-lg hover:bg-indigo-500 hover:text-white transition">
                                        Prev
                                    </a>
                                @endif
