        ...
        <form action="{{ route('profile.store') }}" method="post">
            ...
            <div class="mb-3">
                <label class="block mb-2 text-sm font-medium text-gray-900" for="skills">
                    Enter skills within the scope of information technology, creative industries,
                    and accounting <small>(separate with commas)</small>
                </label>
                <input
                    type="text"
                    name="skills"
            ...
            <div class="mb-3">
                ...
                <select name="preferred_role" class="block w-full px-3 py-2.5 bg-neutral-secondary-medium
